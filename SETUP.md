...
2. 05: default operation-aware SD-WAN load balancing via mwan3
3. 06: optional VPS bonding only if needed
4. 07-09: SQM, policy routing, 4G failover
5. 10-11: LuCI monitoring addons and web UI verification
6. 12-13: hardening/verification

Default deployment does **not** require a VPS or custom dashboard.
