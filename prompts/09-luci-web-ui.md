...
5. Confirm WAN affinity web UI is reachable at `http://10.25.0.1/cgi-bin/wan-affinity`.
...
- WAN affinity UI reachable at `http://10.25.0.1/cgi-bin/wan-affinity`.
